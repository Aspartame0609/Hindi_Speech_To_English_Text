package com.example.speechtotexthindi;
            ...
            public void onClick(View view) {
                ...
                hindiEnglishTranslator.downloadModelIfNeeded(conditions).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MainActivity.this, "Couldn't download the model", Toast.LENGTH_SHORT).show();
                        return;
                    }
                });
                ...
                hindiEnglishTranslator.translate(matches.get(0)).addOnSuccessListener(new OnSuccessListener<String>() {
                    ...
                    public void onSuccess(String s) {
                        editText.setText(s);
                        Toast.makeText(MainActivity.this, "Translation successful!", Toast.LENGTH_SHORT).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(MainActivity.this, "Downloading Hindi Model...", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
